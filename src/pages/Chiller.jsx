...
const CHANNELS = [
  { key: "CH1", label: "Chiller 1 (RTAC 250)", table: "cMT-C21B_CH1_data", color: { light: "#1e6fd9", dark: "#60a5fa" } },
  { key: "CH2", label: "Chiller 2 (RTAC 250)", table: "cMT-C21B_CH2_data", color: { light: "#e8590c", dark: "#fb923c" } },
  { key: "CH3", label: "Chiller 3 (30KA1400)", table: "cMT-C21B_CH3_data", color: { light: "#0f9960", dark: "#34d399" } },
  { key: "CH4", label: "Chiller 4 (30KA1050)", table: "cMT-C21B_CH4_data", color: { light: "#c2255c", dark: "#fb7185" } },
];

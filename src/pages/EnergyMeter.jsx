...
function FlowMeterDisplay({ uid, label, flow, status, total, unit = "m³/h" }) {
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <svg viewBox="50 0 800 900" className="w-full h-full" style={{ maxWidth: 650 }}>
        <defs>
    ...
    <g
  fontFamily="'Segmen7', monospace"
  fill="#263322"
  opacity="0.9"
>
            <text x="270" y="285" fontSize="19" fontWeight="700" fill="#525252f6">Flow</text>
            <text x="380" y="285" fontSize="19" fontWeight="700" fill="#525252f6">{flowText} {unit}</text>
            {/* <text x="270" y="309" fontSize="30">Rate</text>
            <text x="380" y="309" fontSize="30" fontWeight="700" fill={statusColor}>{statusText}</text> */}
            <text x="270" y="340" fontSize="19" fontWeight="700" fill="#525252f6">NET</text>  
            <text x="380" y="340" fontSize="19" fontWeight="700" fill="#525252f6">{totalText} m³</text>
          </g>
          ...
          <g fontFamily="Arial, sans-serif" fontSize="30" textAnchor="middle">
            ...
            <text x="540" y="631" fill="#fff" fontWeight="700" fontSize="20">ENT</text>
          </g>
          ...
          <g>
            ...
            <text x="470" y="717" textAnchor="middle" fontFamily="Arial" fontSize="20" fill="#414141">CAUTION</text>
            <text x="470" y="731" textAnchor="middle" fontFamily="Arial" fontSize="10" fill="#414141">Do not open the cover</text>
          </g>
        </g>

    ...
    <div className="flex flex-col items-center gap-1">
      <svg viewBox="0 0 1280 1120" className="w-full h-auto" style={{ maxWidth: 260 }}>
        ...
        <g fontFamily="Consolas, 'Courier New', monospace" fontWeight="600" fill="#1f2a1f">
          <text x="345" y="390" fontSize="28">{line(v, 1, "V")}</text>
          <text x="345" y="435" fontSize="28">{line(a, 1, "A")}</text>
          <text x="345" y="480" fontSize="28">{line(kw, 2, "kW")}</text>
          <text x="345" y="525" fontSize="28">{line(kwh, 1, "kWh")}</text>
        </g>
      </svg>

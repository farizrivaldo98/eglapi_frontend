...
// Daftar meter yang bisa dipilih di dropdown. Backend (getEnergyPowerHistorical)
// cuma query 1 tabel sesuai `meter` yang dikirim (lihat ENERGY_POWER_TABLES di
// databaseControllers.js). Kalau nanti nambah meter power baru, tinggal
// tambah entry di sini pakai `key` yang sama dengan key di ENERGY_POWER_TABLES
// backend - dropdown, chart, tabel, dan PDF export otomatis ikut.
const METERS = [

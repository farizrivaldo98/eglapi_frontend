// ═══════════════════════════════════════════════════════════════════
// EnvironmentManagementSystem (EMS)
// Tab "EMS" pada Scadamonitor.jsx — monitoring Temp/RH/DP per ruangan
// via AHU, sama persis dengan isi Scadamonitor.jsx sebelumnya, hanya
// dipindah ke sini & di-rename jadi EnvironmentManagementSystem().
// ═══════════════════════════════════════════════════════════════════
...
// ─────────────────────────────────────────────────────────────────
// Mapping nama ruangan (tampilan) → nama tabel di database
// ─────────────────────────────────────────────────────────────────
const roomToTable = {
  "Stripping3":        "cMT-C21B_Striping3_data",
  "Blistering2":       "cMT-C21B_Blister2_data",
  "Stripping2":        "cMT-C21B_Stripping2_data",
  "Tableting2":        "cMT-C21B_Tableting2_data",
  "Spare4":            "cMT-C21B_Spare4_data",
  "ChangeP3":          "cMT-C21B_ChangeP3_data",
  "StaggingF1":        "cMT-C21B_StaggingF1_data",
  "StaggingWIP3":      "cMT-C21B_StaggingWIP3_data",
  "Sorting2":          "cMT-C21B_Sorting2_data",
  "Sorting1":          "cMT-C21B_Sorting1_data",
  "StaggingWIP2":      "cMT-C21B_StaggingWIP2_data",
  "Ipc3":              "cMT-C21B_Ipc3_data",
  "AirLock12":         "cMT-C21B_AirLock12_data",
  "Airlock10":         "cMT-C21B_Airlock10_data",
  "AirLock15":         "cMT-C21B_AirLock15_data",
  "Spare5":            "cMT-C21B_Spare5_data",
  "Coating2":          "cMT-C21B_Coating2_data",
  "CoatingSP1":        "cMT-C21B_CoatingSP1_data",
  "Stair2":            "cMT-C21B_Stair2_data",
  "Airlock8":          "cMT-C21B_Airlock8_data",
  "Locker_Exc":        "cMT-C21B_LockerExc_data",
  "Airlock7":          "cMT-C21B_Airlock7_data",
  "Staging_AW2":       "cMT-C21B_Staging AW2_data",
  "Drink3":            "cMT-C21B_Drink3_data",
  "Prod_Spv3":         "cMT-C21B_ProdSPV3_data",
  "Washing2":          "cMT-C21B_Washing2_data",
  "Stair4":            "cMT-C21B_Stair4_data",
  "Corridor_E4":       "cMT-C21B_Corridor E4_data",
  "Buffer2":           "cMT-C21B_Buffer2_data",
  "Machine_Airlock2":  "cMT-C21B_Machine Airlock2_data",
  "Dirty_Equipment2":  "cMT-C21B_DirtyEquipment2_data",
  "Draining2":         "cMT-C21B_Draining2_data",
  "Clean_Equipment2":  "cMT-C21B_CleanEquipment2_data",
  "Coating1":          "cMT-C21B_Coating1_data",
  "Granulation1":      "cMT-C21B_Granulation1_data",
  "Technical_Room":    "cMT-C21B_TechnicalRoom_data",
  "Coating4":          "cMT-C21B_Coating4_data",
  "Granulation2":      "cMT-C21B_Granulation2_data",
  "Technical_Area":    "cMT-C21B_TechnicalArea_data",
  "Sorting4":          "cMT-C21B_Sorting4_data",
  "Sorting3":          "cMT-C21B_Sorting3_data",
  "Airlock18":         "cMT-C21B_Airlock18_data",
  "Stagging_WIP4":     "cMT-C21B_StagingWIP4_data",
  "Mat_Airlock5":      "cMT-C21B_MATAirlock5_data",
  "Corridor_E6":       "cMT-C21B_CorridorE6_data",
  "Airlock16":         "cMT-C21B_Airlock16_data",
  "Tableting4":        "cMT-C21B_Tableting4_data",
  "Coating_Sp2":       "cMT-C21B_CostingSP2_data",
  "Coating3":          "cMT-C21B_Coating3_data",
  "Stripping6":        "cMT-C21B_Stripping6_data",
  "Janitor6":          "cMT-C21B_Janitor6_data",
  "Extention3":        "cMT-C21B_Extention3_data",
  "Tableting1":        "cMT-C21B_Tableting1_data",
  "Capsule_Filling1":  "cMT-C21B_CaspsuleFilling1_data",
  "Airlock14":         "cMT-C21B_Airlock14_data",
  "Airlock13":         "cMT-C21B_Airlock13_data",
  "Final_Mixing1":     "cMT-C21B_FinalMixing1_data",
  "Final_Mixing2":     "cMT-C21B_FinalMixing2_data",
  "Tableting3":        "cMT-C21B_Tableting3_data",
  "Airlock17":         "cMT-C21B_Airlock17_data",
  "Capsul_Filling2":   "cMT-C21B_CapsulFilling2_data",
  "Airlock19":         "cMT-C21B_Airlock19_data",
  "Blistering3":       "cMT-C21B_Blistering3_data",
  "Stripping5":        "cMT-C21B_Stripping5_data",
  "Stripping4":        "cMT-C21B_Stripping4_data",
  "Staging_WIP5":      "cMT-C21B_StagingWIP5_data",
  "Airlock20":         "cMT-C21B_Airlock20_data",
  "Blistering1":       "cMT-C21B_Blistering1_data",
  "Stripping1":        "cMT-C21B_Stripping1_data",
  "Filling_Dry_Sirup": "cMT-C21B_FillingDrySirup_data",
  "Airlock11":         "cMT-C21B_Airlock11_data",
  "Janitor5":          "cMT-C21B_Janitor5_data",
  "Airlock18_2":       "cMT-C21B_Airlock18_2_data",
  "Material_Airlock4": "cMT-C21B_MaterialAirlock4_data",
  "Corridor_E5":       "cMT-C21B_CorridorE5_data",
};

// ─────────────────────────────────────────────────────────────────
export default function EnvironmentManagementSystem() {
  ...
  // Saat popup terbuka, isi field dengan nilai saat ini + muat grafik
  useEffect(() => {
    if (!popupData) return;
    ...
    // Reset & muat grafik dengan rentang default 1 jam
    setChartHours(1);
    setChartData([]);
    fetchChartData(popupData.room, popupData.type, 1);
  }, [popupData]);
  ...
  // ──────────────── Grafik historis ─────────────────────────────
  const fetchChartData = async (room, type, hours) => {
    setChartLoading(true);
    setChartError(null);

    // format: 0=Suhu, 1=RH, 2=DP  (sama dengan Utility.jsx getTempChart)
    const format = type === "Tx" ? 0 : type === "Rx" ? 1 : 2;
    // Lookup nama tabel dari mapping; fallback ke konvensi default jika belum terdaftar
    const area   = roomToTable[room] ?? `cMT-C21B_${room}_data`;

    const finishDate = new Date();
    const startDate  = new Date(finishDate.getTime() - hours * 3600000);
    ...
    try {
      const res = await axios.get("http://10.163.0.66:8002/part/getTempChart", {
        params: { area, start: fmtDate(startDate), finish: fmtDate(finishDate), format },
      });
      setChartData(res.data || []);
    } catch (err) {
      console.error("Gagal fetch chart:", err);
      setChartError("Gagal memuat grafik. Periksa koneksi server.");
    } finally {
  ...
  const getChartOptions = () => {
    if (!popupData) return { data: [] };
    const { type } = popupData;
    const label = getTypeLabel(type);
    const unit  = CHART_UNITS[type]  ?? "";
    const color = CHART_COLORS[type] ?? "#888";

    // Strip lines SP_H & SP_L di grafik
    const spHnum = parseFloat(editSpH);
    const spLnum = parseFloat(editSpL);
    const stripLines = [
      ...(!isNaN(spHnum) ? [{
        value: spHnum, label: "SP_H",
        color: "#dc2626", labelFontColor: "#dc2626",
        lineDashType: "dash", thickness: 1,
      }] : []),
      ...(!isNaN(spLnum) ? [{
        value: spLnum, label: "SP_L",
        color: "#d97706", labelFontColor: "#d97706",
        lineDashType: "dash", thickness: 1,
      }] : []),
    ];
  ...
  // ──────────────── Ganti rentang waktu grafik ──────────────────
  const handleChartHoursChange = (hours) => {
    setChartHours(hours);
    if (popupData) fetchChartData(popupData.room, popupData.type, hours);
  };
  ...
  const chartTheme   = useColorModeValue("light2", "dark2");
  const chartBgColor = useColorModeValue("transparent", "#171717");
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      {/* ── Modal Edit Limit + Grafik ───────────────────────────── */}
      <Modal isOpen={isOpen} onClose={onClose} isCentered size="2xl">
        <ModalOverlay />
        <ModalContent>
          <ModalHeader borderBottomWidth="1px">
            {getTypeLabel(popupData?.type)} — {popupData?.room}
          ...
          <ModalBody py={3} maxH="80vh" overflowY="auto">
            <Stack spacing={2}>
              {/* Info rows */}
              {[
                ["AHU",       popupData?.ahu],
                ...
                <div key={lbl} className="flex justify-between items-center border-b pb-1">
                  <span className="font-semibold text-gray-500 text-sm">{lbl}</span>
                  <span className="font-bold text-sm">{val}</span>
                </div>
              ))}

              <div className="flex justify-between items-center border-b pb-1">
                <span className="font-semibold text-gray-500 text-sm">Current Value</span>
                <span className="font-bold text-blue-600 text-sm">
                  {typeof popupData?.val === "number"
                    ? `${popupData.val.toFixed(1)} ${CHART_UNITS[popupData?.type] ?? ""}`
                    : (popupData?.val ?? "—")}
                </span>
              </div>
              ...
              <Stack direction="row" spacing={2} align="center" flexWrap="wrap">
                <Text fontSize="xs" fontWeight="semibold" color="gray.500">Rentang:</Text>
                {CHART_TIME_RANGES.map(({ label, hours }) => (
                  <Button
                    key={hours}
                    size="xs"
                    colorScheme={chartHours === hours ? "blue" : "gray"}
                    variant={chartHours === hours ? "solid" : "outline"}
                    onClick={() => handleChartHoursChange(hours)}
                    isLoading={chartLoading && chartHours === hours}
                  >
                    {label}
                  </Button>
                ))}
              ...
              <Box minH="200px">
                {chartLoading ? (
                  ...
                  <div className="flex justify-center items-center h-48">
                    <Text color="red.400" fontSize="sm">{chartError}</Text>
                  </div>
                ) : chartData.length === 0 ? (
                  <div className="flex justify-center items-center h-48">
                    <Text color="gray.400" fontSize="sm">
                      Tidak ada data untuk rentang {chartHours} jam terakhir
                    </Text>
                  </div>
                ) : (
              ...
              <div className="flex justify-between items-center pb-2">
                <span className="font-semibold text-gray-500 text-sm">Timer Limit (menit)</span>
                <Input

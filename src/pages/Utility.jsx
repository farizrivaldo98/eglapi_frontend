...
const exportToPDF = async () => {
  ...
  // 🚨 KUNCI PERBAIKAN 1: Teks ini HARUS dipendekkan jadi "{p}" saja
  // Jangan pakai "{total_pages_count_string}" lagi
  ...
  const drawHeader = () => {
    // Logo perusahaan
    doc.addImage(logo, "JPEG", 14, 8, 25, 12); // Geser logo sedikit ke X:14 agar lurus dengan tabel
    ...
    // Garis pembatas disamakan marginnya (kiri 14, kanan 14)

...
const exportToPDF = async () => {
  ...
  // Format untuk tampilan di Footer (Contoh: 01/07/2026 14:30)
  const formattedDateTime = `${day}/${month}/${year} ${hours}:${minutes}`;
  
  // Format angka untuk Nama File (Contoh: 20260701_1430)
  ...
  autoTable(doc, {
    ...
    didDrawPage: (data) => {
      ...
      // 📝 Footer sekarang menampilkan teks EMS + Date Time
      doc.text(`Generated by EMS System - ${formattedDateTime}`, 10, pageHeight - 10);
  ...
  // 💾 Nama file dinamis menggunakan angka date time (Contoh: table-data-EMS-20260701_1430.pdf)

...
const logoBase64 = "data:image/png;base64,...";
  ...
  const drawHeader = () => {
    ...
    doc.text("PT LAPI LABORATORIES", pageWidth / 2, 15, {
      align: "center",
    });
  ...
  autoTable(doc, {
    ...
    didDrawPage: () => {
      ...
      // Footer kiri
      doc.text("Generated by EMS System", 10, pageHeight - 10);

      // Footer kanan (page number)
      doc.text(

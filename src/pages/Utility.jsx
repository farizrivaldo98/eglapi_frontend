...
const exportToPDF = async () => {
  ...
  autoTable(doc, {
    columns, 
    body: allDataTable,
    startY: 35, // Posisi awal tabel di halaman pertama (di bawah garis)
    margin: { top: 35, bottom: 20 }, // KUNCI: Margin atas untuk hal 2 dst, margin bawah agar tidak nabrak footer
    ...
    didDrawPage: (data) => {
      ...
      // Footer berada di posisi Y: pageHeight - 10
